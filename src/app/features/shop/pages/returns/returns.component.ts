    ...
    <div class="bb-container py-12 page-enter max-w-4xl mx-auto">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-neutral-500 text-sm sm:text-base max-w-xl mx-auto">
          Newborn Baby & Kids Clothing Policy — soft, safe, and hassle-free replacements.
        </p>
      </div>
      ...
      <div class="card p-6 sm:p-8 mb-8 bg-white dark:bg-neutral-800/40 border border-neutral-100 dark:border-neutral-700/60 rounded-3xl shadow-sm leading-relaxed text-sm text-neutral-700 dark:text-neutral-300">
        At <strong class="text-primary font-bold">Happy Hamper</strong>, we want you to be happy with your purchase. If you receive a product that is damaged, defective, or incorrect, you may request a replacement subject to the terms below.
      </div>
      ...
      <div class="space-y-6">
        ...
        <div class="card p-6 bg-white dark:bg-neutral-800/40 border border-neutral-100 dark:border-neutral-700/60 rounded-3xl shadow-sm">
          ...
          <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-3">A replacement may be requested if:</p>
        ...
        <div class="card p-6 bg-white dark:bg-neutral-800/40 border border-neutral-100 dark:border-neutral-700/60 rounded-3xl shadow-sm">
          ...
          <p class="text-sm leading-relaxed text-neutral-700 dark:text-neutral-300">
            Replacement requests must be raised within <strong class="text-neutral-900 dark:text-white font-bold">7 days of delivery</strong>. Requests made after this period may not be accepted.
          </p>
        </div>
        ...
        <div class="card p-6 bg-white dark:bg-neutral-800/40 border border-neutral-100 dark:border-neutral-700/60 rounded-3xl shadow-sm">
          ...
          <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-3">To be eligible for replacement, the items must meet the following criteria:</p>
          <ul class="list-disc pl-5 space-y-2 text-sm text-neutral-700 dark:text-neutral-300">
        ...
        <div class="card p-6 bg-white dark:bg-neutral-800/40 border border-neutral-100 dark:border-neutral-700/60 rounded-3xl shadow-sm">
          ...
          <ul class="list-disc pl-5 space-y-2 text-sm text-neutral-700 dark:text-neutral-300">
            ...
            <li class="list-none text-xs text-neutral-450 italic mt-1">(This information may be required to verify the replacement request.)</li>
          </ul>
        </div>
        ...
        <div class="card p-6 bg-white dark:bg-neutral-800/40 border border-neutral-100 dark:border-neutral-700/60 rounded-3xl shadow-sm">
          ...
          <p class="text-sm leading-relaxed text-neutral-700 dark:text-neutral-300">
            Replacement for a wrong size ordered by the customer will be accepted <strong class="text-neutral-900 dark:text-white">only if</strong> the product is unused, unworn, unwashed, and available in the required size. Replacement is subject to stock availability.
          </p>
        </div>
        ...
        <div class="card p-6 bg-white dark:bg-neutral-800/40 border border-neutral-100 dark:border-neutral-700/60 rounded-3xl shadow-sm">
          ...
          <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-3">If the requested replacement product is unavailable, we may offer:</p>
          <ul class="list-disc pl-5 space-y-2 text-sm text-neutral-700 dark:text-neutral-300">
        ...
        <div class="card p-6 bg-white dark:bg-neutral-800/40 border border-neutral-100 dark:border-neutral-700/60 rounded-3xl shadow-sm">
          ...
          <p class="text-sm leading-relaxed text-neutral-700 dark:text-neutral-300 space-y-2">
            <span>If the replacement is due to an error on our part, such as receiving a damaged, defective, or incorrect product, we will arrange the replacement according to our applicable shipping process.</span>
            <br/><br/>
        ...
        <div class="card p-6 bg-white dark:bg-neutral-800/40 border border-neutral-100 dark:border-neutral-700/60 rounded-3xl shadow-sm">
          ...
          <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-3">Products may not be eligible for replacement if:</p>
          <ul class="list-disc pl-5 space-y-2 text-sm text-neutral-700 dark:text-neutral-300">
            ...
            <li>The replacement request is made after the applicable time period (7 days).</li>
          </ul>
        </div>
        ...
        <div class="card p-6 bg-white dark:bg-neutral-800/40 border border-neutral-100 dark:border-neutral-700/60 rounded-3xl shadow-sm">
          ...
          <p class="text-sm leading-relaxed text-neutral-700 dark:text-neutral-300">
            All replacement requests are subject to inspection and approval by Happy Hamper. We reserve the right to reject a replacement request if the product does not meet the conditions stated in this policy.
          </p>
        </div>
        ...
        <div class="card p-6 sm:p-8 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-3xl shadow-sm text-center">
          ...
          <p class="text-sm text-neutral-600 dark:text-neutral-400 mb-6 max-w-md mx-auto">
            To request a replacement, please contact our customer support team through the official contact channel and provide:
          </p>
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6 max-w-xl mx-auto">
            ...
            <div class="bg-white dark:bg-neutral-900 p-4 rounded-2xl border border-neutral-100 dark:border-neutral-700">
              ...
              <p class="text-sm font-bold text-neutral-700 dark:text-neutral-300">Reason for replacement</p>
            </div>
            <div class="bg-white dark:bg-neutral-900 p-4 rounded-2xl border border-neutral-100 dark:border-neutral-700">
          ...
          <p class="text-xs text-neutral-400 max-w-sm mx-auto leading-relaxed">
            Our support team will review your request and provide further instructions. By placing an order with Happy Hamper, you agree to these Replacement Terms & Conditions.
          </p>
        </div>
      </div>
    </div>
